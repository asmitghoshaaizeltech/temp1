      ...
      {currentDataPoint && (
        <div className="flex flex-col items-center mt-4">
          <div className="w-24 h-24 rounded-full border-2 border-gray-300 flex items-center justify-center relative">
            ...
            <div className="absolute text-gray-600 font-bold text-sm">
              {currentDataPoint.icon}
            </div>
          </div>
...
const Dashboard: FC = function () {
  ...
  const [boarddata, boardsetData]: any = useState({
    DeviceID: "",
    Packet_Date_Time: "",
    BatteryVoltage: "",
    Inside_Temp: "",
  ...
  const [sensordata, sensorsetData]: any = useState({
    Temperature: "",
    TemperatureREF: "",
    RH_REF: "",
    RHGUS13: "",
  ...
  const [GPSdata, GPSsetData]: any = useState({
    UTC_Date_Time: "",
    Latitude: "",
    Longitude: "",
    Altitude: "",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-center">
            ...
            <div className="flex flex-col gap-y-3">
              <div className="flex gap-x-3 justify-between">
                <label className="font-semibold flex-1 text-gray-700">
                  Select Device ID
                </label>
                <select className="flex-1 border border-gray-300 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                  <option value=""></option>
            ...
            <div className="flex flex-col gap-y-3">
              <div className="flex gap-x-3">
                <div className="flex-1 rounded-md shadow-md">
                  ...
                  <div className="px-2">
                    <div className="px-2 py-1 text-sm text-center text-gray-600">
                      ALL
                    </div>
                  </div>
                </div>
